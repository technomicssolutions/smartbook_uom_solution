...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounting_transaction', 'credit_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounting.LedgerEntry']))

        # Changing field 'Transaction.debit_ledger'
        db.alter_column(u'accounting_transaction', 'debit_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounting.LedgerEntry']))
