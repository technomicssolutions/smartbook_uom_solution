...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.transaction_ref'
        db.add_column(u'accounting_transaction', 'transaction_ref',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Transaction.transaction_ref'
        db.delete_column(u'accounting_transaction', 'transaction_ref')
