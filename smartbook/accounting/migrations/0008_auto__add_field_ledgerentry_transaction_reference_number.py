...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LedgerEntry.transaction_reference_number'
        db.add_column(u'accounting_ledgerentry', 'transaction_reference_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LedgerEntry.transaction_reference_number'
        db.delete_column(u'accounting_ledgerentry', 'transaction_reference_number')
