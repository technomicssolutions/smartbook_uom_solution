...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'accounting_transaction', 'amount')

        # Adding field 'Transaction.debit_amount'
        db.add_column(u'accounting_transaction', 'debit_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Transaction.credit_amount'
        db.add_column(u'accounting_transaction', 'credit_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Transaction.amount'
        db.add_column(u'accounting_transaction', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Transaction.debit_amount'
        db.delete_column(u'accounting_transaction', 'debit_amount')

        # Deleting field 'Transaction.credit_amount'
        db.delete_column(u'accounting_transaction', 'credit_amount')
    ...
    models = {
        ...
        u'accounting.transaction': {
            ...
            'credit_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
            ...
            'debit_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
