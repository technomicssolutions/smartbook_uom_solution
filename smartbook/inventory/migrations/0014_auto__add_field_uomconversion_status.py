...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UOMConversion.status'
        db.add_column(u'inventory_uomconversion', 'status',
                      self.gf('django.db.models.fields.CharField')(default='not used', max_length=15),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UOMConversion.status'
        db.delete_column(u'inventory_uomconversion', 'status')
