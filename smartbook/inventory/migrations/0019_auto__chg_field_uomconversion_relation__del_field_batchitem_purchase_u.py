...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UOMConversion.relation'
        db.alter_column(u'inventory_uomconversion', 'relation', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))
        # Deleting field 'BatchItem.purchase_unit'
        db.delete_column(u'inventory_batchitem', 'purchase_unit')


        # Changing field 'BatchItem.purchase_price'
        db.alter_column(u'inventory_batchitem', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))

        # Changing field 'BatchItem.selling_price'
        db.alter_column(u'inventory_batchitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))

        # Changing field 'BatchItem.quantity'
        db.alter_column(u'inventory_batchitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=5))
    def backwards(self, orm):

        # Changing field 'UOMConversion.relation'
        db.alter_column(u'inventory_uomconversion', 'relation', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
        # Adding field 'BatchItem.purchase_unit'
        db.add_column(u'inventory_batchitem', 'purchase_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BatchItem.purchase_price'
        db.alter_column(u'inventory_batchitem', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'BatchItem.selling_price'
        db.alter_column(u'inventory_batchitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'BatchItem.quantity'
        db.alter_column(u'inventory_batchitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
    models = {
        u'inventory.batch': {
