...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OpeningStockItem.purchase_unit'
        db.delete_column(u'inventory_openingstockitem', 'purchase_unit')

    def backwards(self, orm):
        # Adding field 'OpeningStockItem.purchase_unit'
        db.add_column(u'inventory_openingstockitem', 'purchase_unit',
