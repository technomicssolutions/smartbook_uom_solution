...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.product'
        db.alter_column(u'inventory_item', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Product'], null=True))

        # Changing field 'Item.brand'
        db.alter_column(u'inventory_item', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Brand'], null=True))
    def backwards(self, orm):
        # Deleting field 'Item.size'
        db.delete_column(u'inventory_item', 'size')


        # User chose to not deal with backwards NULL issues for 'Item.product'
        raise RuntimeError("Cannot reverse this migration. 'Item.product' and its values cannot be restored.")
