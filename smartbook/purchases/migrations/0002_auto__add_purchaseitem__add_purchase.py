...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'purchases_purchaseitem', (
            ...
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=10)),
        ...
        db.create_table(u'purchases_purchase', (
            ...
            ('purchase_invoice_number', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('total_expense', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2)),
        ))
    ...
    models = {
        ...
        u'purchases.purchase': {
            ...
            'purchase_invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
