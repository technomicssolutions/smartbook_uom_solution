...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.purchase_price'
        db.add_column(u'purchases_purchaseitem', 'purchase_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItem.purchase_price'
        db.delete_column(u'purchases_purchaseitem', 'purchase_price')
    ...
    models = {
        ...
        u'purchases.purchase': {
            ...
            'total_expense': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'})
        },
