...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Purchase.total_expense'
        db.delete_column(u'purchases_purchase', 'total_expense')

    def backwards(self, orm):
        # Adding field 'Purchase.total_expense'
        db.add_column(u'purchases_purchase', 'total_expense',
