...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.profit'
        db.add_column(u'purchases_purchaseitem', 'profit',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

        # Adding field 'Purchase.do_number'
        db.add_column(u'purchases_purchase', 'do_number',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItem.profit'
        db.delete_column(u'purchases_purchaseitem', 'profit')

        # Deleting field 'Purchase.do_number'
        db.delete_column(u'purchases_purchase', 'do_number')
