...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.card_holder_name'
        db.add_column(u'purchases_purchase', 'card_holder_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Purchase.card_holder_name'
        db.delete_column(u'purchases_purchase', 'card_holder_name')
