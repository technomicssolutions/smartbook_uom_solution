...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PurchaseItem.quantity'
        db.alter_column(u'purchases_purchaseitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=10))
    models = {
        u'accounting.ledger': {
        ...
        u'purchases.purchaseitem': {
            ...
            'profit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '10'}),
