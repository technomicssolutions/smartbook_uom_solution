...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PurchaseItem.profit'
        db.alter_column(u'purchases_purchaseitem', 'profit', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=10))

        # Changing field 'PurchaseItem.purchase_price'
        db.alter_column(u'purchases_purchaseitem', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))

        # Changing field 'PurchaseItem.selling_price'
        db.alter_column(u'purchases_purchaseitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=2))
