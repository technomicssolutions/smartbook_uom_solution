...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseItem.purchase'
        db.alter_column(u'purchases_purchaseitem', 'purchase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchases.Purchase'], null=True))

        # Changing field 'PurchaseItem.item'
        db.alter_column(u'purchases_purchaseitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True))
    def backwards(self, orm):
        # Deleting field 'PurchaseItem.batch'
        db.delete_column(u'purchases_purchaseitem', 'batch_id')


        # User chose to not deal with backwards NULL issues for 'PurchaseItem.purchase'
        raise RuntimeError("Cannot reverse this migration. 'PurchaseItem.purchase' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PurchaseItem.item'
        raise RuntimeError("Cannot reverse this migration. 'PurchaseItem.item' and its values cannot be restored.")
    models = {
        u'accounting.ledger': {
