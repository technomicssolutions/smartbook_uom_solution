...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseItem.batch'
        db.delete_column(u'purchases_purchaseitem', 'batch_id')

        # Deleting field 'PurchaseItem.item'
        db.delete_column(u'purchases_purchaseitem', 'item_id')

        # Adding field 'PurchaseItem.batch_item'
        db.add_column(u'purchases_purchaseitem', 'batch_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BatchItem'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'PurchaseItem.batch'
        db.add_column(u'purchases_purchaseitem', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Batch'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseItem.item'
        db.add_column(u'purchases_purchaseitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PurchaseItem.batch_item'
        db.delete_column(u'purchases_purchaseitem', 'batch_item_id')
