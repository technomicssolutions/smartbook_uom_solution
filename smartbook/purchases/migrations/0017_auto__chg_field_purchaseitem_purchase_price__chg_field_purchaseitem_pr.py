...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseItem.purchase_price'
        db.alter_column(u'purchases_purchaseitem', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'PurchaseItem.profit'
        db.alter_column(u'purchases_purchaseitem', 'profit', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'PurchaseItem.selling_price'
        db.alter_column(u'purchases_purchaseitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'PurchaseItem.net_amount'
        db.alter_column(u'purchases_purchaseitem', 'net_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'PurchaseItem.quantity'
        db.alter_column(u'purchases_purchaseitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))

        # Changing field 'PurchaseItem.cost_price'
        db.alter_column(u'purchases_purchaseitem', 'cost_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=5))
    def backwards(self, orm):

        # Changing field 'PurchaseItem.purchase_price'
        db.alter_column(u'purchases_purchaseitem', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'PurchaseItem.profit'
        db.alter_column(u'purchases_purchaseitem', 'profit', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'PurchaseItem.selling_price'
        db.alter_column(u'purchases_purchaseitem', 'selling_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'PurchaseItem.net_amount'
        db.alter_column(u'purchases_purchaseitem', 'net_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'PurchaseItem.quantity'
        db.alter_column(u'purchases_purchaseitem', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))

        # Changing field 'PurchaseItem.cost_price'
        db.alter_column(u'purchases_purchaseitem', 'cost_price', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=10))
    models = {
        u'accounting.ledger': {
        ...
        u'purchases.purchaseitem': {
            ...
            'profit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '5'}),
