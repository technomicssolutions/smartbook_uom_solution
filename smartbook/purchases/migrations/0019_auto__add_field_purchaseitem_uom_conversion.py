...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.uom_conversion'
        db.add_column(u'purchases_purchaseitem', 'uom_conversion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.UOMConversion'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItem.uom_conversion'
        db.delete_column(u'purchases_purchaseitem', 'uom_conversion_id')
    ...
    models = {
        ...
        u'inventory.uomconversion': {
            ...
            'relation': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '2'}),
