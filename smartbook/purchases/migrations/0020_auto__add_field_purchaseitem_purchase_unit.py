...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.purchase_unit'
        db.add_column(u'purchases_purchaseitem', 'purchase_unit',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItem.purchase_unit'
        db.delete_column(u'purchases_purchaseitem', 'purchase_unit')
