...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseItem.selling_price'
        db.delete_column(u'purchases_purchaseitem', 'selling_price')

        # Adding field 'PurchaseItem.whole_sale_price'
        db.add_column(u'purchases_purchaseitem', 'whole_sale_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'PurchaseItem.retail_price'
        db.add_column(u'purchases_purchaseitem', 'retail_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'PurchaseItem.selling_price'
        db.add_column(u'purchases_purchaseitem', 'selling_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Deleting field 'PurchaseItem.whole_sale_price'
        db.delete_column(u'purchases_purchaseitem', 'whole_sale_price')

        # Deleting field 'PurchaseItem.retail_price'
        db.delete_column(u'purchases_purchaseitem', 'retail_price')
