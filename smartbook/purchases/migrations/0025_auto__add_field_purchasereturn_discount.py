...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseReturn.discount'
        db.add_column(u'purchases_purchasereturn', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseReturn.discount'
        db.delete_column(u'purchases_purchasereturn', 'discount')
