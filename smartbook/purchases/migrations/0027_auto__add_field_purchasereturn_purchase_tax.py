...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseReturn.purchase_tax'
        db.add_column(u'purchases_purchasereturn', 'purchase_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseReturn.purchase_tax'
        db.delete_column(u'purchases_purchasereturn', 'purchase_tax')
