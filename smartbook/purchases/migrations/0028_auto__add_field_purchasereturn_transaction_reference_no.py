...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseReturn.transaction_reference_no'
        db.add_column(u'purchases_purchasereturn', 'transaction_reference_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseReturn.transaction_reference_no'
        db.delete_column(u'purchases_purchasereturn', 'transaction_reference_no')
