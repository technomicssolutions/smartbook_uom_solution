...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'purchases.frightvalue': {
            'Meta': {'object_name': 'FrightValue'},
            'fright_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
