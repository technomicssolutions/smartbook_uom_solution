...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FrightValue'
        db.delete_table(u'purchases_frightvalue')

        # Adding model 'FreightValue'
        db.create_table(u'purchases_freightvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('freight_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=10, blank=True)),
        ))
        db.send_create_signal(u'purchases', ['FreightValue'])

    def backwards(self, orm):
        # Adding model 'FrightValue'
        db.create_table(u'purchases_frightvalue', (
            ('fright_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=10, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'purchases', ['FrightValue'])
    ...
    models = {
        ...
        u'purchases.freightvalue': {
            ...
            'freight_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
