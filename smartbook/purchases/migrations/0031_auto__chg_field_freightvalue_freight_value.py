...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FreightValue.freight_value'
        db.alter_column(u'purchases_freightvalue', 'freight_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=5))
    def backwards(self, orm):

        # Changing field 'FreightValue.freight_value'
        db.alter_column(u'purchases_freightvalue', 'freight_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=10))
    models = {
        u'accounting.ledger': {
