...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseItem.unit_discount'
        db.add_column(u'purchases_purchaseitem', 'unit_discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

        # Adding field 'PurchaseItem.unit_freight'
        db.add_column(u'purchases_purchaseitem', 'unit_freight',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PurchaseItem.unit_discount'
        db.delete_column(u'purchases_purchaseitem', 'unit_discount')

        # Deleting field 'PurchaseItem.unit_freight'
        db.delete_column(u'purchases_purchaseitem', 'unit_freight')
    ...
    models = {
        ...
        u'purchases.purchaseitem': {
            ...
            'unit_freight': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '5'}),
            'uom': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'uom_conversion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.UOMConversion']", 'null': 'True', 'blank': 'True'}),
            'whole_sale_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '5'})
        },
