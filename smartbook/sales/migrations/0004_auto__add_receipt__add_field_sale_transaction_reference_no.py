...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sale.transaction_reference_no'
        db.add_column(u'sales_sale', 'transaction_reference_no',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sale.transaction_reference_no'
        db.delete_column(u'sales_sale', 'transaction_reference_no')
