...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Receipt.invoice_type'
        db.delete_column(u'sales_receipt', 'invoice_type')

    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table(u'sales_invoice')

        # Adding field 'Receipt.invoice_type'
        db.add_column(u'sales_receipt', 'invoice_type',
