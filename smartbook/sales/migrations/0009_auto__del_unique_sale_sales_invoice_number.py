...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Sale', fields ['sales_invoice_number']
        db.delete_unique(u'sales_sale', ['sales_invoice_number'])

    def backwards(self, orm):
        # Adding unique constraint on 'Sale', fields ['sales_invoice_number']
        db.create_unique(u'sales_sale', ['sales_invoice_number'])
