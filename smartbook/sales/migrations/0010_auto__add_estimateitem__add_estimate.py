...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_estimateitem', (
            ...
            ('estimate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Estimate'])),
        ...
        db.create_table(u'sales_estimate', (
            ...
            ('salesman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Salesman'], null=True, blank=True)),
