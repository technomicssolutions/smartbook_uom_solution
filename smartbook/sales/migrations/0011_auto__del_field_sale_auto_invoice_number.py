...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sale.auto_invoice_number'
        db.delete_column(u'sales_sale', 'auto_invoice_number')

    def backwards(self, orm):
        # Adding field 'Sale.auto_invoice_number'
        db.add_column(u'sales_sale', 'auto_invoice_number',
