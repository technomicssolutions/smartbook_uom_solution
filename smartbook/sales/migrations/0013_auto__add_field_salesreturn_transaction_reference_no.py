...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesReturn.transaction_reference_no'
        db.add_column(u'sales_salesreturn', 'transaction_reference_no',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesReturn.transaction_reference_no'
        db.delete_column(u'sales_salesreturn', 'transaction_reference_no')
    ...
    models = {
        ...
        u'sales.estimateitem': {
            ...
            'estimate': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sales.Estimate']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
