...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstimateItem.batch_item'
        db.add_column(u'sales_estimateitem', 'batch_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BatchItem'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EstimateItem.batch_item'
        db.delete_column(u'sales_estimateitem', 'batch_item_id')
