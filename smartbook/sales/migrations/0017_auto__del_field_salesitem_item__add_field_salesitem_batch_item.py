...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SalesItem.batch_item'
        db.add_column(u'sales_salesitem', 'batch_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BatchItem'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'SalesItem.item'
        db.add_column(u'sales_salesitem', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SalesItem.batch_item'
        db.delete_column(u'sales_salesitem', 'batch_item_id')
