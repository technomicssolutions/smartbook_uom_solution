...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesReturnItem.uom'
        db.add_column(u'sales_salesreturnitem', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesReturnItem.uom'
        db.delete_column(u'sales_salesreturnitem', 'uom')
