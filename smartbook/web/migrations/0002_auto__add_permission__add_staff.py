...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Staff'], null=True, blank=True)),
        ...
        db.send_create_signal(u'web', ['Permission'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'web_permission')
    ...
    models = {
        ...
        u'web.permission': {
            ...
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Staff']", 'null': 'True', 'blank': 'True'})
        },
        u'web.staff': {
