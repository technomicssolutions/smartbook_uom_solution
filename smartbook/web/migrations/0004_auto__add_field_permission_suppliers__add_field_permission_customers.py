...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permission.suppliers'
        db.add_column(u'web_permission', 'suppliers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Permission.customers'
        db.add_column(u'web_permission', 'customers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Permission.suppliers'
        db.delete_column(u'web_permission', 'suppliers')

        # Deleting field 'Permission.customers'
        db.delete_column(u'web_permission', 'customers')
