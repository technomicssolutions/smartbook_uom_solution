...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_salesman', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
        ...
        db.send_create_signal(u'web', ['Salesman'])

    def backwards(self, orm):
        # Deleting model 'Salesman'
        db.delete_table(u'web_salesman')
